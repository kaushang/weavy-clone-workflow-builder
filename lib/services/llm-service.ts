...
//   try {
//     console.log(`🤖 Executing LLM for node ${params.nodeId}`); // 13
//     console.log('📦 LLM Params:', { // 14
//       model: params.model,
...
//     // Trigger the task
//     const response = await axios.post('/api/trigger/run', {
//       taskId: 'run-llm',
//       payload: {
//         model: params.model,
...
//     };
//   } catch (error: any) {
//     console.error(`❌ LLM execution failed for node ${params.nodeId}:`, error); // 15
//     console.error('Error details:', error.response?.data); // 16
